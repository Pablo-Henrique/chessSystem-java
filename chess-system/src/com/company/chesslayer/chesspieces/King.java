...
public class King extends ChessPiece {
    ...
    private boolean testRookCastling(Position position) {
        ChessPiece chessPosition = (ChessPiece) getBoard().piece(position);
        return chessPosition != null && chessPosition instanceof Rook && chessPosition.getColor() == getColor() && chessPosition.getMoveCount() == 0;
    }
